package HernandezSierraChristian.ReadUtil;
...
public class ReadUtil
{
    ...
    private ReadUtil(){scanner= new Scanner(System.in);}
    ...
    public static String read() {return getInstance().getScanner().nextLine();}
